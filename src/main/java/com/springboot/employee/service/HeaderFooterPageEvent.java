...
public class HeaderFooterPageEvent extends PdfPageEventHelper {
  public void onStartPage(PdfWriter writer, Document document) {
    ...
    Phrase phrase = new Phrase(waterMarkText, new Font(FontFamily.TIMES_ROMAN, 90, // Select the
                                                                                   // Font type of
        Font.ITALIC, // Select the Font style of waterMark Text
        BaseColor.LIGHT_GRAY)); // Select the Font colour of waterMark Text

    ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER, // Keep waterMark
                                                                                // center aligned
  ...
  public void onEndPage(PdfWriter writer, Document document) {
    ...
    ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER, linkText,
