...
import com.springboot.employee.service.EmployeeEsService;
...
public class EmployeeController{
	...
	//	serviceEs.getEmployeeFull(id);
		return employeeService.getEmployee(id);
	}

	@PostMapping("/add")
	public Employee addEmp(@RequestBody Employee employee) {
		//serviceEs.getEmployeeFull(employee.getEmployId());
...
//             .body(new InputStreamResource(b));
		String fileName = "example-"+localDate+".pdf";
	...
	public List<Employeedocument> searchEmployee(@PathVariable("text") String text) {
		return employeeEsService.searchEmployee(text);
	}
	
	@GetMapping("/search/{firstname}/{relationship}")
	public List<Employeedocument> searchByFirstnameRelationship(@PathVariable("firstname") String firstname, @PathVariable("relationship") String relationship){
		return employeeEsService.searchByFirstnameAndRelationship(firstname,relationship);
	}
}
